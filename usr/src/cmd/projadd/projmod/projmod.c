...
#define	CHECK_ERRORS_FREE_PLIST(perrlst, pplist, ecode) {	\
...
#define TEXT_DOMAIN "SYS_TEST"		/* Use this only if it wasn't */
	...
	CHECK_ERRORS_FREE_PLIST(&errlst, plist, 2);
